...
const notifyLeadChange = () => {
if (typeof window !== "undefined") {
window.dispatchEvent(
new Event("nexaflow:lead-change")
);
}
};
...
try {
  ...
  if (!response.ok || !data.success) {
    throw new Error(
      data.error || "Unable to update lead status."
    );
  }
...
return ( <main className="relative min-h-screen overflow-hidden bg-[#151713] text-[#F4F0E6] selection:bg-[#E7B84B]/20 selection:text-[#F5D98B]">
