...
function HomeIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-[18px] w-[18px]" fill="none" stroke="currentColor" strokeWidth="1.7">
      <path d="m4 10 8-6 8 6v9a1 1 0 0 1-1 1h-5v-6H10v6H5a1 1 0 0 1-1-1v-9Z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function WorkflowIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-[18px] w-[18px]" fill="none" stroke="currentColor" strokeWidth="1.7">
      ...
      <path d="M8 6h4a6 6 0 0 1 6 6M8 18h4a6 6 0 0 0 6-6" strokeLinecap="round" />
    </svg>
  );
}
...
function ConversationIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-[18px] w-[18px]" fill="none" stroke="currentColor" strokeWidth="1.7">
      <path d="M5 6.5A2.5 2.5 0 0 1 7.5 4h9A2.5 2.5 0 0 1 19 6.5v7a2.5 2.5 0 0 1-2.5 2.5H11l-4.5 4v-4.2A2.5 2.5 0 0 1 5 13.5v-7Z" strokeLinecap="round" strokeLinejoin="round" />
...
function LeadsIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-[18px] w-[18px]" fill="none" stroke="currentColor" strokeWidth="1.7">
      ...
      <path d="M3.5 19a5.5 5.5 0 0 1 11 0M16 7a3 3 0 1 1 0 6M16 15.5a4.5 4.5 0 0 1 4.5 3.5" strokeLinecap="round" />
    </svg>
  );
}
...
export default function Sidebar() {
      ...
      {showUpgradeCard && (
        <div className="relative mx-3 mb-3 overflow-hidden rounded-[15px] border border-[#E7B84B]/15 bg-[#20241D]">
          ...
          <button
            ...
            className="absolute right-2.5 top-2.5 flex h-6 w-6 items-center justify-center rounded-lg text-[#777B72] transition-colors hover:bg-[#F4F0E6]/[0.05] hover:text-[#F4F0E6]"
          >
            <CloseIcon />
          </button>
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="relative hidden h-screen w-[272px] flex-col overflow-hidden border-r border-[#F5D98B]/[0.07] bg-[#121410] lg:flex">
