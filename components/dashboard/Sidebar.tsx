...
function LogoMark() {
return ( <div className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-[13px] border border-[#E7B84B]/25 bg-[#252A22] shadow-[0_0_24px_rgba(231,184,75,0.08)]"> <div className="absolute inset-[5px] rounded-[9px] border border-[#F5D98B]/10" />
...
return ( <svg
   ...
   stroke="currentColor"
   strokeWidth="1.7"
 > <rect x="4" y="4" width="6" height="6" rx="1" /> <rect x="14" y="4" width="6" height="6" rx="1" /> <rect x="4" y="14" width="6" height="6" rx="1" /> <rect x="14" y="14" width="6" height="6" rx="1" /> </svg>
);
}
...
return ( <svg
   ...
   stroke="currentColor"
   strokeWidth="1.7"
 > <circle cx="6" cy="6" r="2" /> <circle cx="18" cy="12" r="2" /> <circle cx="6" cy="18" r="2" /> <path
...
return ( <svg
 ...
 > <path
     ...
     strokeLinecap="round"
     strokeLinejoin="round"
   /> <path d="M9 9h6M9 12h4" strokeLinecap="round" /> </svg>
);
}
...
return ( <svg
   ...
   stroke="currentColor"
   strokeWidth="1.7"
 > <rect x="4" y="4" width="16" height="16" rx="2" /> <path
...
return ( <svg
   ...
   stroke="currentColor"
   strokeWidth="1.7"
 > <path d="M5 19V10M12 19V5M19 19v-7" strokeLinecap="round" /> <path d="M3.5 19.5h17" strokeLinecap="round" /> </svg>
);
}
...
>
{isActive && ( <span className="absolute left-0 top-1/2 h-6 w-[2px] -translate-y-1/2 rounded-r-full bg-[#E7B84B] shadow-[0_0_12px_rgba(231,184,75,0.75)]" />
)}
...
const STORAGE_KEY = "nexaflow-upgrade-dismissed";
...
const navigation = ( <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
{/* Workspace */} <div className="px-4 pb-5"> <div className="mb-2 px-2 font-mono text-[9px] uppercase tracking-[0.18em] text-[#777B72]">
Workspace </div>
...
<>
{/* Desktop sidebar */}
{desktopOpen && ( <aside className="relative hidden h-screen w-[248px] flex-col overflow-hidden border-r border-[#F5D98B]/[0.07] bg-[#121410] lg:flex">
{/* Subtle sidebar atmosphere */} <div className="pointer-events-none absolute inset-0"> <div className="absolute -left-24 top-16 h-64 w-64 rounded-full bg-[#E7B84B]/[0.035] blur-[90px]" /> <div className="absolute bottom-20 right-[-90px] h-72 w-72 rounded-full bg-[#5ED6A0]/[0.018] blur-[100px]" />
